        ...
        success: function (result) {
            ...
            $('.drugSelect').chosen({
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        $("#drugInfo_type").val(result.data.drugType);
                        $("#drugInfo_efficacyClassification").val(result.data.efficacyClassification);
                        $("#drugInfo_specification").val(result.data.specification);
                        $("#drugInfo_manufacturer").val(result.data.manufacturer);
                        $("#drugInfo_storageQuantity").val(result.data.storageQuantity)
                    }
                })
            });
        }
